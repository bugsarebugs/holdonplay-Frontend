...
export default function FirstSection(){
    ...
    return (
        <div ref={boxRef} className="h-dvh flex flex-col justify-center relative align-middle self-center text-justify lg:text-center items-center bg-[url('/hero.jpg')] bg-cover ">
            <h1 className="lg:text-7xl text  text-4xl text-center font-bold p-2"><span className="text-blue-400">Music Distribution</span> Services</h1>
